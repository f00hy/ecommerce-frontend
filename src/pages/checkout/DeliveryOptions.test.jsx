...
describe('DeliveryOptions component', () => {
  ...
  it('renders delivery options correctly', () => {
    ...
    expect(within(deliveryOptionElems[0]).getByTestId('delivery-option-input').checked).toBe(false);
    ...
    expect(within(deliveryOptionElems[1]).getByTestId('delivery-option-input').checked).toBe(true);

    expect(deliveryOptionElems[2]).toHaveTextContent('Monday, May 12');
    expect(deliveryOptionElems[2]).toHaveTextContent('$9.99 - Shipping');
    expect(within(deliveryOptionElems[2]).getByTestId('delivery-option-input').checked).toBe(false);
  });
